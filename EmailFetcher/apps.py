...
#         logging.getLogger(__name__).info(f"check_pnr_remonte lancé à {now.isoformat()}")

#     except Exception as e:
#         logging.getLogger(__name__).exception("Erreur lors de l'exécution de pnr_remonte")
