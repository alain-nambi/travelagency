...
def test_parsing_upload_file(request):
    ...
    if 'file' in request.FILES:
        try:
            ...
            with open('/opt/issoufali/travelagencygit/travelagency/EmailFetcher/utilities/attachments_dir/test@test.com/' + uploaded_file_name, 'wb') as destination_file:
                for chunk in uploaded_file.chunks():
                    destination_file.write(chunk)

            pdf_image = fitz.open('/opt/issoufali/travelagencygit/travelagency/EmailFetcher/utilities/attachments_dir/test@test.com/' + uploaded_file_name)
...
def test_parsing_zenith(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            temp.set_path('//opt/issoufali//travelagencygit//travelagency//EmailFetcher//utilities//attachments_dir//' + attachement_folder + '//' + uploaded_file_name)
            temp.set_email_date(None)
            temp.set_main_txt_path('//opt//issoufali//travelagencygit//travelagency//EmailFetcher//utilities//attachments_dir//' + attachement_folder + '//' + attachement_folder + '.txt')
...
def test_parsing_text(request):
    ...
    try: 
        ...
        chemin =  '/opt/issoufali/travelagencygit/travelagency/EmailFetcher/utilities/attachments_dir/' + file 
        ...
        temp.set_path('/opt/issoufali/travelagencygit/travelagency/EmailFetcher/utilities/attachments_dir/' + file )
