...
values -- PNR source
    (
        ...
        'Email PNR',
        null,
        '"address"=>"issoufali.pnr@gmail.com", "password"=>"lhlyyumveqvyqhqo"',
        now(),
        now(),
        true
    ),
    (
        ...
        'Email PNR',
        null,
        '"address"=>"tjq.issoufali@gmail.com", "password"=>"gvtlqduhdbiijjsd"',
        now(),
        now(),
        true
    ),
    ...
    (
        ...
        null,
        '"address"=>"errorreport.issoufali.pnr@gmail.com", "password"=>"chnversafifnzagp", "smtp"=>"smtp.gmail.com", "port"=>"587"',
        now(),
        now(),
        true
    ),
    ...
    (
        ...
        'Email Source',
        'Global',
        'Anomaly email sender',
        null,
        '"address"=>"anomalie.issoufali.pnr@gmail.com", "password"=>"qczyzeytdvlbcysq", "smtp"=>"smtp.gmail.com", "port"=>"587"',
        now(),
        now(),
        true
    ),
    ...
    (
        ...
        'Email Source',
        'Global',
        'PNR not fetched notification sender',
        null,
        '"address"=>"anomalie.issoufali.pnr@gmail.com", "password"=>"qczyzeytdvlbcysq", "smtp"=>"smtp.gmail.com", "port"=>"587"',
        now(),
        now(),
    ...
    (
        ...
        'Fee request sender',
        null,
        '"address"=>"feerequest.issoufali.pnr@gmail.com", "password"=>"tnkunwvygtdkxfxg", "smtp"=>"smtp.gmail.com", "port"=>"587"',
        now(),
        now(),
        true
    ),
