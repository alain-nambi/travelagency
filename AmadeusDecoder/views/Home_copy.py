...
def get_quotation(request, pnr_id):
    ...
    file_dir = '/opt/issoudali/odoo/issoufali-addons/import_saleorder/data/source'
    customer_dir = '/opt/issoudali/odoo/issoufali-addons/contacts_from_incadea/data/source'
