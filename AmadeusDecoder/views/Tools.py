...
def call_product_import(request):
    path_to_file = '/opt/issoufali/odoo/issoufali-addons/sync_products/data/exported/Products.csv'
...
def call_customer_import(request):
    path_to_file = '/opt/issoufali/odoo/issoufali-addons/sync_contacts/data/exported/Contacts.csv'
