...
sortTable.init = function () {
  ...
  sheet.insertRule(
    'table.js-sort-asc thead tr > .js-sort-active:not(.js-sort-none):after {content: "\\25b2";font-size: 12px;}',
    0
  );
  sheet.insertRule(
    'table.js-sort-desc thead tr > .js-sort-active:not(.js-sort-none):after {content: "\\25bc";font-size: 12px;}',
    0
  );
};
...
function automaticallySortTable() {
  ...
  sortTable( document.getElementById("all-pnr"), 1, 1)
}
